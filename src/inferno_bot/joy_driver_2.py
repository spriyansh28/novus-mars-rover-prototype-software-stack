...
def find_pwmtest5(msg):
    ...
    right_speed = 0
    if msg.axes[5] < 0 :
        left_speed= msg.axes[5] * (-255/255)
        right_speed = msg.axes[5] * (-255/255)
        if msg.axes[0] < 0 :
            left_speed= msg.axes[5] * (-255/255)
            right_speed = 0
        elif msg.axes[0] > 0 :
        ...
        left_speed= msg.axes[2] * (255/255)
        right_speed = msg.axes[2] * (255/255)
        if msg.axes[0] < 0 :
            left_speed= msg.axes[2] * (255/255)
            right_speed = 0
        elif msg.axes[0] > 0 :
        ...
        left_speed= msg.axes[0] * (-255/255)
        right_speed = -0.2
    elif msg.axes[0] > 0 :
        left_speed = -0.2
        right_speed = msg.axes[0] * (255/255)
